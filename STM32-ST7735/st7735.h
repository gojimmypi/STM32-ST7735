...
#define ST7735_A0_PIN      GPIO_Pin_1 // GPIO_Pin_4    // PB4 EDIT

// ST7735 RST (Reset) pin
#define ST7735_RST_PORT    GPIOB
#define ST7735_RST_PIN     GPIO_Pin_6    // PB6 NOT USED / connected to hardware reset

// ST7735 CS (Chip Select) pin
#define ST7735_CS_PORT     GPIOB
#define ST7735_CS_PIN      GPIO_Pin_12 // GPIO_Pin_7    // PB7 EDIT
